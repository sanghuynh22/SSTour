		...
		<div className="footer">
			<div className="footer_up">
				<div className="footer_left">
					<div className="footer_left_one">
						<p className="footer_one_title"> Hướng dẫn</p>
					...
					<div className="footer_left_two">
						<p className="footer_two_title">Các chi nhánh</p>
						<p>
							<svg
								aria-hidden="true"
								focusable="false"
							...
							HCM: Tầng 2, Tòa nhà SSTour, 28 Lê Văn, Phường 1, Quận 1, Tp. Hồ
							Chí Minh
						</p>
						<p>
							<svg
							...
							Hà Nội: P308 Nguyễn Hữu Cảnh, số 10, P. Tây Hồ, Q.Hoàn Kiếm, Hà
							Nội
						</p>
						<p>
							<svg
							...
							Cần Thơ: Tầng 1 - Tòa nhà SS - 11P Đại Lộ Hòa Bình, P. Tân An, Q.
							Ninh Kiều, TP. Cần Thơ.
						</p>
					</div>
				</div>
				<div class="footer_right">
					<p class="footer_right_title">Thông tin liên lạc</p>
			...
			<div className="footer_down">© 2023 SSTour | Made by SangHuynh</div>
		</div>
	);
};
